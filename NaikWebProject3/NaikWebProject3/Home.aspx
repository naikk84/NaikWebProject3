<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="NaikWebProject3.Home" %>
...
<body>
  ...
  <div class="mySlides">
    ...
    <img src="Images/home11.jpg" style="width:100%" height="500" alt="slider image1 "/>
    <div class="text">Style is A way to say who you are, without having to speak</div>
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 4</div>
    <img src="Images/home22.jpg" style="width:100%"  height="500" alt="slider image2"/>
    <div class="text">Your home should tell the story who you are, and be a collection of what you love</div>
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 4</div>
    <img src="Images/home.jpg" style="width:100%" height="500" alt="slider image3"/>
    <div class="text">An interior is the natural projection of the soul</div>
  </div>
            
            <div class="mySlides">
    <div class="numbertext">4 / 4</div>
    <img src="Images/home4.jpg" style="width:100%" height="500" alt="slider image4"/>
